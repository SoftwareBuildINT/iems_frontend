  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-[#091224]">
      <div className="w-full md:w-3/5 relative h-2/5 md:h-full">
        ...
        />
        <img
          src="src/assets/img/buildintloginwhite.png"
          alt="Logo"
        ...
        <div className="w-full md:w-2/5 flex items-center justify-center relative">
          <div className="absolute left-0 md:left-[-10%] w-full md:w-[110%] h-full bg-[#091224] flex flex-col justify-center p-[100px] shadow-lg z-10 rounded-none md:rounded-l-[30px]">
            <div className="absolute top-4 right-4 w-10 h-auto md:w-24 text-white italic flex">
              <span><TiInfoLarge /></span><span className='text-xs'> Need Help?</span>
            </div>
            <h1 className="text-start text-xl md:text-2xl font-bold mb-4 md:mb-6 text-[#E6FC5F]">Welcome to i-EMS</h1>
            <h2 className="text-start text-md md:text-lg font-bold mb-2 md:mb-3 text-white">Login</h2>
            <form className="w-full max-w-sm">
              <div className="mb-4 text-white">
                <label className="block text-start text-white text-sm mb-2" htmlFor="username">
                  Username
                </label>
                <input
              ...
              <div className="mb-4">
                <label className="block text-start text-white text-sm mb-2" htmlFor="password">
                  Password
                </label>
                <input
